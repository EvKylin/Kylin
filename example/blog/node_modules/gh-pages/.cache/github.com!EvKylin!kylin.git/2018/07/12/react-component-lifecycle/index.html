...
<li>
<p>更新<small>(组件已存在时的状态改变)</small></p>
<ul>
<li><a href="#getDerivedStateFromProps">static getDerivedStateFromProps()</a></li>
...
<div class="gatsby-highlight" data-language="javascript">
     ...
     <span class="token keyword">this</span><span class="token punctuation">.</span>state <span class="token operator">=</span> <span class="token punctuation">{</span>color<span class="token punctuation">:</span> props<span class="token punctuation">.</span>color<span class="token punctuation">}</span>
